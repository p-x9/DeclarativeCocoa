...
extension Modify.DynamicMemberWrap where T: NSApplication {
    @discardableResult
    @_disfavoredOverload
    public func hide(_ sender: Any?) -> T {
        self.value.hide(sender)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func unhide(_ sender: Any?) -> T {
        self.value.unhide(sender)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func unhideWithoutActivation() -> T {
        self.value.unhideWithoutActivation()
        return self.value
    }
    ...
    @discardableResult
    @_disfavoredOverload
    public func activate(ignoringOtherApps flag: Swift.Bool) -> T {
        self.value.activate(ignoringOtherApps: flag)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func hideOtherApplications(_ sender: Any?) -> T {
        self.value.hideOtherApplications(sender)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func unhideAllApplications(_ sender: Any?) -> T {
        self.value.unhideAllApplications(sender)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func finishLaunching() -> T {
        self.value.finishLaunching()
        return self.value
    }
    ...
    @discardableResult
    @_disfavoredOverload
    public func stop(_ sender: Any?) -> T {
        self.value.stop(sender)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func stopModal() -> T {
        self.value.stopModal()
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func stopModal(withCode returnCode: AppKit.NSApplication.ModalResponse) -> T {
        self.value.stopModal(withCode: returnCode)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func abortModal() -> T {
        self.value.abortModal()
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func endModalSession(_ session: AppKit.NSApplication.ModalSession) -> T {
        self.value.endModalSession(session)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func terminate(_ sender: Any?) -> T {
        self.value.terminate(sender)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func cancelUserAttentionRequest(_ request: Swift.Int) -> T {
        self.value.cancelUserAttentionRequest(request)
        return self.value
    }
    ...
    @discardableResult
    @_disfavoredOverload
    public func enumerateWindows(options: AppKit.NSApplication.WindowListOptions = [], using block: (AppKit.NSWindow, Swift.UnsafeMutablePointer<ObjectiveC.ObjCBool>) -> Swift.Void) -> T {
        self.value.enumerateWindows(options: options, using: block)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func preventWindowOrdering() -> T {
        self.value.preventWindowOrdering()
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func setWindowsNeedUpdate(_ needUpdate: Swift.Bool) -> T {
        self.value.setWindowsNeedUpdate(needUpdate)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func updateWindows() -> T {
        self.value.updateWindows()
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func reportException(_ exception: Foundation.NSException) -> T {
        self.value.reportException(exception)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func reply(toApplicationShouldTerminate shouldTerminate: Swift.Bool) -> T {
        self.value.reply(toApplicationShouldTerminate: shouldTerminate)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func reply(toOpenOrPrint reply: AppKit.NSApplication.DelegateReply) -> T {
        self.value.reply(toOpenOrPrint: reply)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func orderFrontCharacterPalette(_ sender: Any?) -> T {
        self.value.orderFrontCharacterPalette(sender)
        return self.value
    }
    ...
    @discardableResult
    @_disfavoredOverload
    public func registerUserInterfaceItemSearchHandler(_ handler: AppKit.NSUserInterfaceItemSearching) -> T {
        self.value.registerUserInterfaceItemSearchHandler(handler)
        return self.value
    }
    ...
    @discardableResult
    @_disfavoredOverload
    public func unregisterUserInterfaceItemSearchHandler(_ handler: AppKit.NSUserInterfaceItemSearching) -> T {
        self.value.unregisterUserInterfaceItemSearchHandler(handler)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func runPageLayout(_ sender: Any?) -> T {
        self.value.runPageLayout(sender)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func orderFrontColorPanel(_ sender: Any?) -> T {
        self.value.orderFrontColorPanel(sender)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func activateContextHelpMode(_ sender: Any?) -> T {
        self.value.activateContextHelpMode(sender)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func showHelp(_ sender: Any?) -> T {
        self.value.showHelp(sender)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    @available(macOS, unavailable, introduced: 10.3, deprecated: 10.4, message: "APIs deprecated as of macOS 10.9 and earlier are unavailable in Swift")
    public func application(_ sender: AppKit.NSApplication!, printFiles filenames: [Swift.String]!) -> T {
        self.value.application(sender, printFiles: filenames)
        return self.value
    }
    ...
    public func beginSheet(_ sheet: AppKit.NSWindow, modalFor docWindow: AppKit.NSWindow, modalDelegate: Any?, didEnd didEndSelector: ObjectiveC.Selector?, contextInfo: Swift.UnsafeMutableRawPointer!) -> T {
        self.value.beginSheet(sheet, modalFor: docWindow, modalDelegate: modalDelegate, didEnd: didEndSelector, contextInfo: contextInfo)
        return self.value
    }
    ...
    public func endSheet(_ sheet: AppKit.NSWindow) -> T {
        self.value.endSheet(sheet)
        return self.value
    }
    ...
    public func endSheet(_ sheet: AppKit.NSWindow, returnCode: Swift.Int) -> T {
        self.value.endSheet(sheet, returnCode: returnCode)
        return self.value
    }
    ...
    @discardableResult
    @_disfavoredOverload
    public func registerForRemoteNotifications(matching types: AppKit.NSApplication.RemoteNotificationType) -> T {
    ...
    @discardableResult
    @_disfavoredOverload
    public func disableRelaunchOnLogin() -> T {
        self.value.disableRelaunchOnLogin()
        return self.value
    }
    ...
    @discardableResult
    @_disfavoredOverload
    public func enableRelaunchOnLogin() -> T {
        self.value.enableRelaunchOnLogin()
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func orderFrontStandardAboutPanel(_ sender: Any?) -> T {
        self.value.orderFrontStandardAboutPanel(sender)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func orderFrontStandardAboutPanel(options optionsDictionary: [AppKit.NSApplication.AboutPanelOptionKey : Any] = [:]) -> T {
        self.value.orderFrontStandardAboutPanel(options: optionsDictionary)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func registerServicesMenuSendTypes(_ sendTypes: [AppKit.NSPasteboard.PasteboardType], returnTypes: [AppKit.NSPasteboard.PasteboardType]) -> T {
        self.value.registerServicesMenuSendTypes(sendTypes, returnTypes: returnTypes)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func arrangeInFront(_ sender: Any?) -> T {
        self.value.arrangeInFront(sender)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func removeWindowsItem(_ win: AppKit.NSWindow) -> T {
        self.value.removeWindowsItem(win)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func addWindowsItem(_ win: AppKit.NSWindow, title string: Swift.String, filename isFilename: Swift.Bool) -> T {
        self.value.addWindowsItem(win, title: string, filename: isFilename)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func changeWindowsItem(_ win: AppKit.NSWindow, title string: Swift.String, filename isFilename: Swift.Bool) -> T {
        self.value.changeWindowsItem(win, title: string, filename: isFilename)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func updateWindowsItem(_ win: AppKit.NSWindow) -> T {
        self.value.updateWindowsItem(win)
        return self.value
    }

    @discardableResult
    @_disfavoredOverload
    public func miniaturizeAll(_ sender: Any?) -> T {
        self.value.miniaturizeAll(sender)
        return self.value
    }
