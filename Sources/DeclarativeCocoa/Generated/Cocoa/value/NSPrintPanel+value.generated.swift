...
extension Modify.DynamicMemberWrap where T: NSPrintPanel {
    ...
    @discardableResult
    @_disfavoredOverload
    public func addAccessoryController(_ accessoryController: AppKit.NSViewController & AppKit.NSPrintPanelAccessorizing) -> T {
    ...
    @discardableResult
    @_disfavoredOverload
    public func removeAccessoryController(_ accessoryController: AppKit.NSViewController & AppKit.NSPrintPanelAccessorizing) -> T {
    ...
    @discardableResult
    @_disfavoredOverload
    public func setDefaultButtonTitle(_ defaultButtonTitle: Swift.String?) -> T {
    ...
    public func updateFromPrintInfo() -> T {
    ...
    @_disfavoredOverload
    @available(macOS, unavailable, introduced: 10.0, deprecated: 10.5, message: "APIs deprecated as of macOS 10.9 and earlier are unavailable in Swift")
    public func finalWritePrintInfo() -> T {
