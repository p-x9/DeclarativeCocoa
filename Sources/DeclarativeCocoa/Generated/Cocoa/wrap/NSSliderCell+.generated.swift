...
extension Modify.DynamicMemberWrap where T: NSSliderCell {
    @discardableResult
    public func drawKnob(_ knobRect: Foundation.NSRect) -> Self {
    ...
    @discardableResult
    public func drawBar(inside rect: Foundation.NSRect, flipped: Swift.Bool) -> Self {
    ...
    public func setTitle(_ cell: AppKit.NSCell!) -> Self {
    ...
    @discardableResult
    public func drawTickMarks() -> Self {
