...
extension Modify.DynamicMemberWrap where T: NSCell {
    @discardableResult
    ...
    @discardableResult
    public func setCellAttribute(_ parameter: AppKit.NSCell.Attribute, to value: Swift.Int) -> Self {
        self.value.setCellAttribute(parameter, to: value)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func calcDrawInfo(_ rect: Foundation.NSRect) -> Self {
        self.value.calcDrawInfo(rect)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func drawInterior(withFrame cellFrame: Foundation.NSRect, in controlView: AppKit.NSView) -> Self {
        self.value.drawInterior(withFrame: cellFrame, in: controlView)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func draw(withFrame cellFrame: Foundation.NSRect, in controlView: AppKit.NSView) -> Self {
        self.value.draw(withFrame: cellFrame, in: controlView)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func highlight(_ flag: Swift.Bool, withFrame cellFrame: Foundation.NSRect, in controlView: AppKit.NSView) -> Self {
        self.value.highlight(flag, withFrame: cellFrame, in: controlView)
        return Modify.DynamicMemberWrap(self.value)
    }
    ...
    @discardableResult
    public func stopTracking(last lastPoint: Foundation.NSPoint, current stopPoint: Foundation.NSPoint, in controlView: AppKit.NSView, mouseIsUp flag: Swift.Bool) -> Self {
        self.value.stopTracking(last: lastPoint, current: stopPoint, in: controlView, mouseIsUp: flag)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func edit(withFrame rect: Foundation.NSRect, in controlView: AppKit.NSView, editor textObj: AppKit.NSText, delegate: Any?, event: AppKit.NSEvent?) -> Self {
        self.value.edit(withFrame: rect, in: controlView, editor: textObj, delegate: delegate, event: event)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func select(withFrame rect: Foundation.NSRect, in controlView: AppKit.NSView, editor textObj: AppKit.NSText, delegate: Any?, start selStart: Swift.Int, length selLength: Swift.Int) -> Self {
        self.value.select(withFrame: rect, in: controlView, editor: textObj, delegate: delegate, start: selStart, length: selLength)
        return Modify.DynamicMemberWrap(self.value)
    }
    ...
    @discardableResult
    public func resetCursorRect(_ cellFrame: Foundation.NSRect, in controlView: AppKit.NSView) -> Self {
        self.value.resetCursorRect(cellFrame, in: controlView)
        return Modify.DynamicMemberWrap(self.value)
    }
    ...
    public func setEntryType(_ type: Swift.Int) -> Self {
        self.value.setEntryType(type)
        return Modify.DynamicMemberWrap(self.value)
    }
    ...
    public func setMnemonicLocation(_ location: Swift.Int) -> Self {
        self.value.setMnemonicLocation(location)
        return Modify.DynamicMemberWrap(self.value)
    }
    ...
    @available(macOS 10.5, *)
    @discardableResult
    public func draw(withExpansionFrame cellFrame: Foundation.NSRect, in view: AppKit.NSView) -> Self {
        self.value.draw(withExpansionFrame: cellFrame, in: view)
        return Modify.DynamicMemberWrap(self.value)
    }
    ...
    @discardableResult
    public func drawFocusRingMask(withFrame cellFrame: Foundation.NSRect, in controlView: AppKit.NSView) -> Self {
        self.value.drawFocusRingMask(withFrame: cellFrame, in: controlView)
        return Modify.DynamicMemberWrap(self.value)
    }
}
