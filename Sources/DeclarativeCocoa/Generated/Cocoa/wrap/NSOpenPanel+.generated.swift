...
extension Modify.DynamicMemberWrap where T: NSOpenPanel {
    ...
    public func beginSheet(forDirectory path: Swift.String?, file name: Swift.String?, types fileTypes: [Any]?, modalFor docWindow: AppKit.NSWindow?, modalDelegate delegate: Any?, didEnd didEndSelector: ObjectiveC.Selector?, contextInfo: Swift.UnsafeMutableRawPointer?) -> Self {
    ...
    @discardableResult
    @available(macOS, unavailable, introduced: 10.0, deprecated: 10.6, message: "APIs deprecated as of macOS 10.9 and earlier are unavailable in Swift")
    public func begin(forDirectory path: Swift.String?, file name: Swift.String?, types fileTypes: [Any]?, modelessDelegate delegate: Any?, didEnd didEndSelector: ObjectiveC.Selector?, contextInfo: Swift.UnsafeMutableRawPointer?) -> Self {
