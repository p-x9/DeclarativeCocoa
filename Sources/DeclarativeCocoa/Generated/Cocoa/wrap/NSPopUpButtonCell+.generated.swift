...
extension Modify.DynamicMemberWrap where T: NSPopUpButtonCell {
    ...
    @discardableResult
    public func attachPopUp(withFrame cellFrame: Foundation.NSRect, in controlView: AppKit.NSView) -> Self {
        self.value.attachPopUp(withFrame: cellFrame, in: controlView)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func dismissPopUp() -> Self {
        self.value.dismissPopUp()
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func performClick(withFrame frame: Foundation.NSRect, in controlView: AppKit.NSView) -> Self {
