...
extension Modify.DynamicMemberWrap where T: NSDrawer {
    ...
    @discardableResult
    public func open(on edge: Foundation.NSRectEdge) -> Self {
        self.value.open(on: edge)
        return Modify.DynamicMemberWrap(self.value)
    }
    ...
    @discardableResult
    public func open(_ sender: Any?) -> Self {
        self.value.open(sender)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func close(_ sender: Any?) -> Self {
        self.value.close(sender)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func toggle(_ sender: Any?) -> Self {
        self.value.toggle(sender)
        return Modify.DynamicMemberWrap(self.value)
    }
