...
extension Modify.DynamicMemberWrap where T: NSApplication {
    @discardableResult
    public func hide(_ sender: Any?) -> Self {
        self.value.hide(sender)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func unhide(_ sender: Any?) -> Self {
        self.value.unhide(sender)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func unhideWithoutActivation() -> Self {
    ...
    @discardableResult
    public func activate(ignoringOtherApps flag: Swift.Bool) -> Self {
        self.value.activate(ignoringOtherApps: flag)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func hideOtherApplications(_ sender: Any?) -> Self {
        self.value.hideOtherApplications(sender)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func unhideAllApplications(_ sender: Any?) -> Self {
        self.value.unhideAllApplications(sender)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func finishLaunching() -> Self {
    ...
    @discardableResult
    public func stop(_ sender: Any?) -> Self {
        self.value.stop(sender)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func stopModal() -> Self {
        self.value.stopModal()
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func stopModal(withCode returnCode: AppKit.NSApplication.ModalResponse) -> Self {
        self.value.stopModal(withCode: returnCode)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func abortModal() -> Self {
        self.value.abortModal()
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func endModalSession(_ session: AppKit.NSApplication.ModalSession) -> Self {
        self.value.endModalSession(session)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func terminate(_ sender: Any?) -> Self {
        self.value.terminate(sender)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func cancelUserAttentionRequest(_ request: Swift.Int) -> Self {
    ...
    @discardableResult
    public func enumerateWindows(options: AppKit.NSApplication.WindowListOptions = [], using block: (AppKit.NSWindow, Swift.UnsafeMutablePointer<ObjectiveC.ObjCBool>) -> Swift.Void) -> Self {
        self.value.enumerateWindows(options: options, using: block)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func preventWindowOrdering() -> Self {
        self.value.preventWindowOrdering()
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func setWindowsNeedUpdate(_ needUpdate: Swift.Bool) -> Self {
        self.value.setWindowsNeedUpdate(needUpdate)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func updateWindows() -> Self {
        self.value.updateWindows()
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func reportException(_ exception: Foundation.NSException) -> Self {
        self.value.reportException(exception)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func reply(toApplicationShouldTerminate shouldTerminate: Swift.Bool) -> Self {
        self.value.reply(toApplicationShouldTerminate: shouldTerminate)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func reply(toOpenOrPrint reply: AppKit.NSApplication.DelegateReply) -> Self {
        self.value.reply(toOpenOrPrint: reply)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func orderFrontCharacterPalette(_ sender: Any?) -> Self {
    ...
    @discardableResult
    public func registerUserInterfaceItemSearchHandler(_ handler: AppKit.NSUserInterfaceItemSearching) -> Self {
    ...
    @available(macOS 10.6, *)
    @discardableResult
    public func unregisterUserInterfaceItemSearchHandler(_ handler: AppKit.NSUserInterfaceItemSearching) -> Self {
        self.value.unregisterUserInterfaceItemSearchHandler(handler)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func runPageLayout(_ sender: Any?) -> Self {
        self.value.runPageLayout(sender)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func orderFrontColorPanel(_ sender: Any?) -> Self {
        self.value.orderFrontColorPanel(sender)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func activateContextHelpMode(_ sender: Any?) -> Self {
        self.value.activateContextHelpMode(sender)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func showHelp(_ sender: Any?) -> Self {
    ...
    public func application(_ sender: AppKit.NSApplication!, printFiles filenames: [Swift.String]!) -> Self {
    ...
    public func beginSheet(_ sheet: AppKit.NSWindow, modalFor docWindow: AppKit.NSWindow, modalDelegate: Any?, didEnd didEndSelector: ObjectiveC.Selector?, contextInfo: Swift.UnsafeMutableRawPointer!) -> Self {
    ...
    public func endSheet(_ sheet: AppKit.NSWindow) -> Self {
    ...
    public func endSheet(_ sheet: AppKit.NSWindow, returnCode: Swift.Int) -> Self {
    ...
    @available(macOS 10.7, *)
    @discardableResult
    public func registerForRemoteNotifications(matching types: AppKit.NSApplication.RemoteNotificationType) -> Self {
    ...
    @available(macOS 10.7, *)
    @discardableResult
    public func disableRelaunchOnLogin() -> Self {
    ...
    @available(macOS 10.7, *)
    @discardableResult
    public func enableRelaunchOnLogin() -> Self {
        self.value.enableRelaunchOnLogin()
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func orderFrontStandardAboutPanel(_ sender: Any?) -> Self {
        self.value.orderFrontStandardAboutPanel(sender)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func orderFrontStandardAboutPanel(options optionsDictionary: [AppKit.NSApplication.AboutPanelOptionKey : Any] = [:]) -> Self {
        self.value.orderFrontStandardAboutPanel(options: optionsDictionary)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func registerServicesMenuSendTypes(_ sendTypes: [AppKit.NSPasteboard.PasteboardType], returnTypes: [AppKit.NSPasteboard.PasteboardType]) -> Self {
        self.value.registerServicesMenuSendTypes(sendTypes, returnTypes: returnTypes)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func arrangeInFront(_ sender: Any?) -> Self {
        self.value.arrangeInFront(sender)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func removeWindowsItem(_ win: AppKit.NSWindow) -> Self {
        self.value.removeWindowsItem(win)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func addWindowsItem(_ win: AppKit.NSWindow, title string: Swift.String, filename isFilename: Swift.Bool) -> Self {
        self.value.addWindowsItem(win, title: string, filename: isFilename)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func changeWindowsItem(_ win: AppKit.NSWindow, title string: Swift.String, filename isFilename: Swift.Bool) -> Self {
        self.value.changeWindowsItem(win, title: string, filename: isFilename)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func updateWindowsItem(_ win: AppKit.NSWindow) -> Self {
        self.value.updateWindowsItem(win)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func miniaturizeAll(_ sender: Any?) -> Self {
