...
extension Modify.DynamicMemberWrap where T: UITableViewCell {
    ...
    @discardableResult
    public func setSelected(_ selected: Swift.Bool, animated: Swift.Bool) -> Self {
        self.value.setSelected(selected, animated: animated)
        return Modify.DynamicMemberWrap(self.value)
    }

    @discardableResult
    public func setHighlighted(_ highlighted: Swift.Bool, animated: Swift.Bool) -> Self {
    ...
    @available(iOS 3.0, *)
    @discardableResult
    public func willTransition(to state: UIKit.UITableViewCell.StateMask) -> Self {
    ...
    @available(iOS 3.0, *)
    @discardableResult
    public func didTransition(to state: UIKit.UITableViewCell.StateMask) -> Self {
    ...
    @available(iOS 11.0, *)
    @discardableResult
    public func dragStateDidChange(_ dragState: UIKit.UITableViewCell.DragState) -> Self {
